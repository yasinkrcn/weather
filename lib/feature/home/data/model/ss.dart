...
//         list: json["list"] == null ? [] : List<HourlyWeatherListElement>.from(json["list"]!.map((x) => HourlyWeatherListElement.fromMap(x))),
//       );
// }
...
//         weather: json["weather"] == null ? [] : List<HourlyWeatherDescription>.from(json["weather"]!.map((x) => HourlyWeatherDescription.fromMap(x))),
